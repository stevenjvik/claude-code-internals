...
If you run Ollama on a different node (e.g., nx-ai-01 at 192.168.10.31):

```bash
export ANTHROPIC_BASE_URL="http://192.168.10.31:11434/v1"
...
|-----------|----------|-----|
| File reads, searches, scaffolding | Ollama CPU (nx-ai-01) | Free, good enough |
